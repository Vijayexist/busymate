  ...
  <div class="row">
    <div class="col-md-4"> 
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="#">Service Request</a></li>
           <li><a href="#service"><span class="glyphicon glyphicon-wrench"></span>&nbsp;TS O9 BL 8289</a></li>
        <li><a href="#service"><span class="glyphicon glyphicon-wrench"></span>&nbsp;TS O9 BL 8289</a></li>
         <li><a href="#service"><span class="glyphicon glyphicon-wrench"></span>&nbsp;TS O9 BL 8289</a></li>
        <li><a href="#service"><span class="glyphicon glyphicon-wrench"></span>&nbsp;TS O9 BL 8289</a></li>
      </ul>
    ...
    <div class="col-md-4"> 
     <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="#feedback"><span class="glyphicon glyphicon-indent-right"></span>&nbsp;TS O9 BL 8289</a></li>   <li><a href="#feedback">TS O9 BL 8289</a></li>
        <li><a href="#feedback"><span class="glyphicon glyphicon-indent-right"></span>&nbsp;TS O9 BL 8289</a></li>
      </ul>
    </div>
    <div class="col-md-4"> 
